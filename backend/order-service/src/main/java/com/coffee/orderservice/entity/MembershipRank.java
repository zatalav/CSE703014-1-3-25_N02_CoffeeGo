...
public class MembershipRank {
    ...
    public Long getMinTotalMoney() { return minTotalMoney; }
    public void setMinTotalMoney(Long minTotalMoney) { this.minTotalMoney = minTotalMoney; }
    public Integer getMinTotalOrders() { return minTotalOrders; }
    public void setMinTotalOrders(Integer minTotalOrders) { this.minTotalOrders = minTotalOrders; }
    ...
    public Double getDripsMultiplier() { return dripsMultiplier; }
    public void setDripsMultiplier(Double dripsMultiplier) { this.dripsMultiplier = dripsMultiplier; }
