...
@Service
public class EmployeeAdminServiceImpl extends CrudServiceSupport<Employee, Long, EmployeeRequest, EmployeeResponse> implements EmployeeAdminService {
    ...
    public EmployeeAdminServiceImpl(EmployeeRepository repository, EmployeeMapper mapper, EmployeeDetailRepository detailRepository,
    ...
    public EmployeeResponse create(EmployeeRequest request) {
        validateEmailRequired(request.getEmail());
    ...
    private void validateEmailRequired(String email) {
        if (blankToNull(email) == null) {
            throw new BadRequestException("Employee email is required to send the temporary password");
        }
    }
