...
@Validated
@RestController
@RequestMapping("/api/admin/users/managers")
@PreAuthorize("hasRole('admin')")
public class ManagerAdminController {
    private final ManagerAdminService service;

    public ManagerAdminController(ManagerAdminService service) {
        this.service = service;
    }

    @GetMapping
    public ApiResponse<PageResponse<EmployeeResponse>> list(@RequestParam Map<String, String> params, @PageableDefault(size = 10) Pageable pageable) {
