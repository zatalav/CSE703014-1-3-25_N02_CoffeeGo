...
@Validated
@RestController
@RequestMapping("/api/admin/users/customers")
@PreAuthorize("hasRole('admin')")
public class UserCustomerAdminController {
    private final UserCustomerAdminService service;

    public UserCustomerAdminController(UserCustomerAdminService service) {
